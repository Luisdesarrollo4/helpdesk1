        ...
        public function loginUsuario($usuario, $password) {
            ...
            if (mysqli_num_rows($respuesta) > 0) {
                ...
                if ($datosUsuarios['activo'] == 1) {
                    ...
                    $_SESSION['usuario']['area'] = $datosUsuarios['area'];
                    // Crear un array para los datos a enviar
                    $datosRespuesta = array(
                        "loginStatus" => 1, // Inicio de sesión exitoso
                        "area" => $datosUsuarios['area']
                    );
                    // Devolver los datos en formato JSON
                    return json_encode($datosRespuesta);
                } else {
